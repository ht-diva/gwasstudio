...
@cloup.option_group(
    "Ingestion options",
    cloup.option( "--gwas-vcf-path", default=None, help="Path to a folder where all the vcf.gz files to ingest are present"),
    cloup.option("-a", "--attrs", help="List of extra attributes to add, provided as a single string comma separated"),
    cloup.option("-to","--tiledb-path-out", default=None, help="s3 path where the tiledb dataset is created")
)
@cloup.option_group(
    "TileDB configurations",
    cloup.option("-b", "--mem-budget-mb", default=20480, help="The memory budget in MB when ingesting the data"),
    cloup.option("-tr", "--threads", default=16, help="The number fo threwads used for ingestion"),
