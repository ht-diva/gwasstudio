...
run_command "Exporting data with multiallelic filtering..." "gwasstudio --stdout --verbosity loud --mongo-uri ${MDB_URI} export --search-file data/search_example_multiallelic.yml --output-prefix ${TEST_DIR}/example_export_multiallelic_filtering --uri ${TILEDB_DIR} --filter-multiallelic 2>&1"
...
run_command "Exporting data..." "gwasstudio --stdout --verbosity loud --mongo-uri ${MDB_URI} export --search-file data/search_example_06.yml --output-prefix ${TEST_DIR}/example_export_skip_meta --plot-out --skip-meta 2>&1"

# Export data with a different file format and batch size
run_command "Exporting data..." "gwasstudio --verbosity loud --stdout --batch-size 4 --mongo-uri ${MDB_URI} export --search-file data/search_example_01.yml --output-prefix ${TEST_DIR}/example_export --output-format parquet 2>&1"
...
run_command "Regions filtering with multiallelic filtering..." "gwasstudio --stdout --mongo-uri ${MDB_URI} export --search-file data/search_example_multiallelic.yml --output-prefix ${TEST_DIR}/example_regions_filtering_multiallelic_filtering --output-format csv --get-regions-snps data/regions_query.tsv --filter-multiallelic 2>&1"
...
run_command "Regions filtering with P-value threshold and skip regions output..." "gwasstudio --stdout --mongo-uri ${MDB_URI} export --search-file data/search_example_01.yml --output-prefix ${TEST_DIR}/example_regions_filtering_pvalue_skipout --output-format csv --get-regions-snps data/regions_query.tsv --pvalue-filt 7.30103 --skip-out 2>&1"

# Regions filtering
run_command "Regions filtering..." "gwasstudio --stdout --mongo-uri ${MDB_URI} export --search-file data/search_example_01.yml --output-prefix ${TEST_DIR}/example_regions_filtering_by_arg --output-format csv --get-regions-snps '13,23947562,94021213;15,471752,49338760' 2>&1"
...
run_command "SNPs filtering with multiallelic filtering..." "gwasstudio --stdout --workers 4 --mongo-uri ${MDB_URI} export --search-file data/search_example_multiallelic.yml --output-prefix ${TEST_DIR}/example_snps_filtering_multiallelic_filtering --get-regions-snps data/hapmap3/hapmap3_snps.csv --filter-multiallelic 2>&1"
...
run_command "Lead-SNP search with multiallelic filtering..." "gwasstudio --stdout --workers 4 --mongo-uri ${MDB_URI} export --search-file data/search_example_multiallelic.yml --output-prefix ${TEST_DIR}/example_leadsnp_search_multiallelic_filtering --get-regions-leadsnps data/opengwas_prot-a_Synt_Prolactin_snps.csv --filter-multiallelic 2>&1"
...
run_command "Locusbreaker with multiallelic filtering..." "gwasstudio --stdout --mongo-uri ${MDB_URI} export --search-file data/search_example_multiallelic.yml --output-prefix ${TEST_DIR}/example_locusbreaker_multiallelic_filtering --locusbreaker --filter-multiallelic 2>&1"
