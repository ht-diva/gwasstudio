...
The list is defined in `src/gwasstudio/core/enums.py` under `AncestryEnum`.
...
*The list is version‑controlled; any addition or change should be reflected both in `src/gwasstudio/core/enums.py` and in this documentation.*
