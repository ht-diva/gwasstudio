...
| `file_path` | **File paths** | The paths where the summary-statistics files are stored | e.g. `data/dataset/ukb-d-XVIII_MISCFINDINGS.gwaslab.tsv.sampled.gz` |
...
| `total_samples` | **Number of samples** | Sample size of the cohort | integer |
